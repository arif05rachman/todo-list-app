        ...
        <div style={{ flex: '0 0 auto' }} className='w-full max-w-[235px]' >
            <div
                ...
                <div onClick={getDetailActivity} className='activity-body h-[158px]'>
                    <h4 data-cy='activity-item-title' className='activity-item-tittle text-lg cursor-pointer font-bold'>{title}</h4>
                </div>
                <div className='card-footer flex items-center justify-between'>
                    <span data-cy='activity-item-date' className='text-base text-[#888]'>{date}</span>
                    <HiOutlineTrash
